...
public class ParamUtil {
	...
	public static String getString(
		...
		return normalize(get(request, param, defaultValue));
	}
	...
	public static String getString(
		...
		return normalize(get(portletRequest, param, defaultValue));
	}
	...
	public static String getString(
		...
		return normalize(get(serviceContext, param, defaultValue));
	}
	...
	public static String[] getStringValues(
		...
		return normalize(getStringValues(request, param, new String[0]));
	}
	...
	public static String[] getStringValues(
		...
		return normalize(getStringValues(portletRequest, param, new String[0]));
	}
	...
	public static String[] getStringValues(
		...
		return normalize(getStringValues(serviceContext, param, new String[0]));
	}
