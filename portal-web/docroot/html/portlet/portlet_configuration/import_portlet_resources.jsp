...
FileEntry fileEntry = ExportImportHelperUtil.getTempFileEntry(groupId, themeDisplay.getUserId(), ExportImportHelperUtil.getTempFolderName(selPortlet.getPortletId()));
