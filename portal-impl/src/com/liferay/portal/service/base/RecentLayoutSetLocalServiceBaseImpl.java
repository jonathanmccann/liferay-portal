...
/**
 * Provides the base implementation for the recent layout set local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.service.impl.RecentLayoutSetLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class RecentLayoutSetLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RecentLayoutSetLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portal.service.RecentLayoutSetLocalServiceUtil} to access the recent layout set local service.
	 */
	...
	@Override
	public RecentLayoutSet addRecentLayoutSet(RecentLayoutSet recentLayoutSet) {
	 ...
	 */
	@Override
	public RecentLayoutSet createRecentLayoutSet(long recentLayoutSetId) {
		return recentLayoutSetPersistence.create(recentLayoutSetId);
	}
	...
	@Override
	public RecentLayoutSet deleteRecentLayoutSet(long recentLayoutSetId)
		throws PortalException {
		return recentLayoutSetPersistence.remove(recentLayoutSetId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RecentLayoutSet deleteRecentLayoutSet(
		RecentLayoutSet recentLayoutSet) {
		return recentLayoutSetPersistence.remove(recentLayoutSet);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RecentLayoutSet.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return recentLayoutSetPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return recentLayoutSetPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RecentLayoutSet fetchRecentLayoutSet(long recentLayoutSetId) {
		return recentLayoutSetPersistence.fetchByPrimaryKey(recentLayoutSetId);
	}
	 ...
	 */
	@Override
	public RecentLayoutSet getRecentLayoutSet(long recentLayoutSetId)
		throws PortalException {
		return recentLayoutSetPersistence.findByPrimaryKey(recentLayoutSetId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(com.liferay.portal.service.RecentLayoutSetLocalServiceUtil.getService());
		actionableDynamicQuery.setClass(RecentLayoutSet.class);
		actionableDynamicQuery.setClassLoader(getClassLoader());

		actionableDynamicQuery.setPrimaryKeyPropertyName("recentLayoutSetId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return recentLayoutSetLocalService.deleteRecentLayoutSet((RecentLayoutSet)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return recentLayoutSetPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RecentLayoutSet> getRecentLayoutSets(int start, int end) {
		return recentLayoutSetPersistence.findAll(start, end);
	}
	...
	public int getRecentLayoutSetsCount() {
		return recentLayoutSetPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RecentLayoutSet updateRecentLayoutSet(
		RecentLayoutSet recentLayoutSet) {
		return recentLayoutSetPersistence.update(recentLayoutSet);
	}
	 ...
	 */
	public RecentLayoutSetLocalService getRecentLayoutSetLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.portal.model.RecentLayoutSet",
			recentLayoutSetLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.portal.model.RecentLayoutSet");
	}
	...
	public String getOSGiServiceIdentifier() {
		return RecentLayoutSetLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = recentLayoutSetPersistence.getDataSource();
	...
	protected RecentLayoutSetLocalService recentLayoutSetLocalService;
