...
public class UserIdMapperPersistenceImpl extends BasePersistenceImpl<UserIdMapper>
	...
	protected void bulkRemoveByUserId(long userId) {
		...
		query.append(_SQL_DELETE_USERIDMAPPER_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_USERIDMAPPER);
	...
	private static final String _SQL_SELECT_USERIDMAPPER_PKS = "SELECT userIdMapperId FROM UserIdMapper userIdMapper";
	...
	private static final String _SQL_SELECT_USERIDMAPPER_PKS_WHERE = "SELECT userIdMapperId FROM UserIdMapper userIdMapper WHERE ";
	...
	private static final String _SQL_DELETE_USERIDMAPPER = "DELETE UserIdMapper userIdMapper";
	private static final String _SQL_DELETE_USERIDMAPPER_WHERE = "DELETE UserIdMapper userIdMapper WHERE ";
