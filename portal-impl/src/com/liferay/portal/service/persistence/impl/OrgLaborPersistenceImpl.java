...
public class OrgLaborPersistenceImpl extends BasePersistenceImpl<OrgLabor>
	...
	public void removeByOrganizationId(long organizationId) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByOrganizationId(organizationId);
	...
	protected void bulkRemoveByOrganizationId(long organizationId) {
		StringBundler query = new StringBundler(2);

		query.append(_SQL_DELETE_ORGLABOR_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_ORGLABOR);
	...
	private static final String _SQL_SELECT_ORGLABOR_PKS = "SELECT orgLaborId FROM OrgLabor orgLabor";
	...
	private static final String _SQL_SELECT_ORGLABOR_PKS_WHERE = "SELECT orgLaborId FROM OrgLabor orgLabor WHERE ";
	...
	private static final String _SQL_DELETE_ORGLABOR = "DELETE OrgLabor orgLabor";
	private static final String _SQL_DELETE_ORGLABOR_WHERE = "DELETE OrgLabor orgLabor WHERE ";
