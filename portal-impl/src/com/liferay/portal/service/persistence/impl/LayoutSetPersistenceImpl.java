...
public class LayoutSetPersistenceImpl extends BasePersistenceImpl<LayoutSet>
	...
	protected void bulkRemoveByGroupId(long groupId) {
		...
		query.append(_SQL_DELETE_LAYOUTSET_WHERE);
	...
	public void removeByLayoutSetPrototypeUuid(String layoutSetPrototypeUuid) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByLayoutSetPrototypeUuid(layoutSetPrototypeUuid);
	...
	protected void bulkRemoveByLayoutSetPrototypeUuid(
		String layoutSetPrototypeUuid) {
		StringBundler query = new StringBundler(2);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_LAYOUTSET);
	...
	private static final String _SQL_SELECT_LAYOUTSET_PKS = "SELECT layoutSetId FROM LayoutSet layoutSet";
	...
	private static final String _SQL_SELECT_LAYOUTSET_PKS_WHERE = "SELECT layoutSetId FROM LayoutSet layoutSet WHERE ";
	...
	private static final String _SQL_DELETE_LAYOUTSET = "DELETE LayoutSet layoutSet";
	private static final String _SQL_DELETE_LAYOUTSET_WHERE = "DELETE LayoutSet layoutSet WHERE ";
