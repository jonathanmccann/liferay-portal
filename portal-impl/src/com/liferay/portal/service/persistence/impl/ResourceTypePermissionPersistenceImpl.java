...
public class ResourceTypePermissionPersistenceImpl extends BasePersistenceImpl<ResourceTypePermission>
	...
	protected void bulkRemoveByRoleId(long roleId) {
		...
		query.append(_SQL_DELETE_RESOURCETYPEPERMISSION_WHERE);
	...
	public void removeByC_N_R(long companyId, String name, long roleId) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByC_N_R(companyId, name, roleId);
	...
	protected void bulkRemoveByC_N_R(long companyId, String name, long roleId) {
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_RESOURCETYPEPERMISSION);
	...
	private static final String _SQL_SELECT_RESOURCETYPEPERMISSION_PKS = "SELECT resourceTypePermissionId FROM ResourceTypePermission resourceTypePermission";
	...
	private static final String _SQL_SELECT_RESOURCETYPEPERMISSION_PKS_WHERE = "SELECT resourceTypePermissionId FROM ResourceTypePermission resourceTypePermission WHERE ";
	...
	private static final String _SQL_DELETE_RESOURCETYPEPERMISSION = "DELETE ResourceTypePermission resourceTypePermission";
	private static final String _SQL_DELETE_RESOURCETYPEPERMISSION_WHERE = "DELETE ResourceTypePermission resourceTypePermission WHERE ";
