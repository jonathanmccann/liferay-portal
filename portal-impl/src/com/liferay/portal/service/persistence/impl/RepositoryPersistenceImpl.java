...
public class RepositoryPersistenceImpl extends BasePersistenceImpl<Repository>
	...
	protected void bulkRemoveByUuid(String uuid) {
		...
		query.append(_SQL_DELETE_REPOSITORY_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_REPOSITORY);
	...
	private static final String _SQL_SELECT_REPOSITORY_PKS = "SELECT repositoryId FROM Repository repository";
	...
	private static final String _SQL_SELECT_REPOSITORY_PKS_WHERE = "SELECT repositoryId FROM Repository repository WHERE ";
	...
	private static final String _SQL_DELETE_REPOSITORY = "DELETE Repository repository";
	private static final String _SQL_DELETE_REPOSITORY_WHERE = "DELETE Repository repository WHERE ";
