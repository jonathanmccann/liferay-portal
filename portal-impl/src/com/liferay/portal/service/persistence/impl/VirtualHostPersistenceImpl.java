...
public class VirtualHostPersistenceImpl extends BasePersistenceImpl<VirtualHost>
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_VIRTUALHOST);
	...
	private static final String _SQL_SELECT_VIRTUALHOST_PKS = "SELECT virtualHostId FROM VirtualHost virtualHost";
	...
	private static final String _SQL_SELECT_VIRTUALHOST_PKS_WHERE = "SELECT virtualHostId FROM VirtualHost virtualHost WHERE ";
	...
	private static final String _SQL_DELETE_VIRTUALHOST = "DELETE VirtualHost virtualHost";
	private static final String _SQL_DELETE_VIRTUALHOST_WHERE = "DELETE VirtualHost virtualHost WHERE ";
