...
public class TicketPersistenceImpl extends BasePersistenceImpl<Ticket>
	...
	protected void bulkRemoveByC_C_T(long classNameId, long classPK, int type) {
		...
		query.append(_SQL_DELETE_TICKET_WHERE);
	...
	public void removeByC_C_C_T(long companyId, long classNameId, long classPK,
		int type) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByC_C_C_T(companyId, classNameId, classPK, type);
	...
	protected void bulkRemoveByC_C_C_T(long companyId, long classNameId,
		long classPK, int type) {
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_TICKET);
	...
	private static final String _SQL_SELECT_TICKET_PKS = "SELECT ticketId FROM Ticket ticket";
	...
	private static final String _SQL_SELECT_TICKET_PKS_WHERE = "SELECT ticketId FROM Ticket ticket WHERE ";
	...
	private static final String _SQL_DELETE_TICKET = "DELETE Ticket ticket";
	private static final String _SQL_DELETE_TICKET_WHERE = "DELETE Ticket ticket WHERE ";
