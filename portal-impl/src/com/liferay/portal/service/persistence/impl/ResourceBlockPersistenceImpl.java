...
public class ResourceBlockPersistenceImpl extends BasePersistenceImpl<ResourceBlock>
	...
	public void removeByC_N(long companyId, String name) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByC_N(companyId, name);
	...
	protected void bulkRemoveByC_N(long companyId, String name) {
		StringBundler query = new StringBundler(3);

		query.append(_SQL_DELETE_RESOURCEBLOCK_WHERE);
	...
	public void removeByC_G_N(long companyId, long groupId, String name) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByC_G_N(companyId, groupId, name);
	...
	protected void bulkRemoveByC_G_N(long companyId, long groupId, String name) {
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_RESOURCEBLOCK);
	...
	private static final String _SQL_SELECT_RESOURCEBLOCK_PKS = "SELECT resourceBlockId FROM ResourceBlock resourceBlock";
	...
	private static final String _SQL_SELECT_RESOURCEBLOCK_PKS_WHERE = "SELECT resourceBlockId FROM ResourceBlock resourceBlock WHERE ";
	...
	private static final String _SQL_DELETE_RESOURCEBLOCK = "DELETE ResourceBlock resourceBlock";
	private static final String _SQL_DELETE_RESOURCEBLOCK_WHERE = "DELETE ResourceBlock resourceBlock WHERE ";
