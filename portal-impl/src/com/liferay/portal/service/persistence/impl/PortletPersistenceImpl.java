...
public class PortletPersistenceImpl extends BasePersistenceImpl<Portlet>
	...
	protected void bulkRemoveByCompanyId(long companyId) {
		...
		query.append(_SQL_DELETE_PORTLET_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_PORTLET);
	...
	private static final String _SQL_SELECT_PORTLET_PKS = "SELECT id_ FROM Portlet portlet";
	...
	private static final String _SQL_SELECT_PORTLET_PKS_WHERE = "SELECT id_ FROM Portlet portlet WHERE ";
	...
	private static final String _SQL_DELETE_PORTLET = "DELETE Portlet portlet";
	private static final String _SQL_DELETE_PORTLET_WHERE = "DELETE Portlet portlet WHERE ";
