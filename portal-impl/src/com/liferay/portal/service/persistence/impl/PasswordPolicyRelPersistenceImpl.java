...
public class PasswordPolicyRelPersistenceImpl extends BasePersistenceImpl<PasswordPolicyRel>
	...
	public void removeByPasswordPolicyId(long passwordPolicyId) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByPasswordPolicyId(passwordPolicyId);
	...
	protected void bulkRemoveByPasswordPolicyId(long passwordPolicyId) {
		StringBundler query = new StringBundler(2);

		query.append(_SQL_DELETE_PASSWORDPOLICYREL_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_PASSWORDPOLICYREL);
	...
	private static final String _SQL_SELECT_PASSWORDPOLICYREL_PKS = "SELECT passwordPolicyRelId FROM PasswordPolicyRel passwordPolicyRel";
	...
	private static final String _SQL_SELECT_PASSWORDPOLICYREL_PKS_WHERE = "SELECT passwordPolicyRelId FROM PasswordPolicyRel passwordPolicyRel WHERE ";
	...
	private static final String _SQL_DELETE_PASSWORDPOLICYREL = "DELETE PasswordPolicyRel passwordPolicyRel";
	private static final String _SQL_DELETE_PASSWORDPOLICYREL_WHERE = "DELETE PasswordPolicyRel passwordPolicyRel WHERE ";
