...
public class ImagePersistenceImpl extends BasePersistenceImpl<Image>
	...
	protected void bulkRemoveByLtSize(int size) {
		StringBundler query = new StringBundler(2);

		query.append(_SQL_DELETE_IMAGE_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_IMAGE);
	...
	private static final String _SQL_SELECT_IMAGE_PKS = "SELECT imageId FROM Image image";
	...
	private static final String _SQL_SELECT_IMAGE_PKS_WHERE = "SELECT imageId FROM Image image WHERE ";
	...
	private static final String _SQL_DELETE_IMAGE = "DELETE Image image";
	private static final String _SQL_DELETE_IMAGE_WHERE = "DELETE Image image WHERE ";
