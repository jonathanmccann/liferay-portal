...
public class UserNotificationDeliveryPersistenceImpl extends BasePersistenceImpl<UserNotificationDelivery>
	...
	protected void bulkRemoveByUserId(long userId) {
		...
		query.append(_SQL_DELETE_USERNOTIFICATIONDELIVERY_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_USERNOTIFICATIONDELIVERY);
	...
	private static final String _SQL_SELECT_USERNOTIFICATIONDELIVERY_PKS = "SELECT userNotificationDeliveryId FROM UserNotificationDelivery userNotificationDelivery";
	...
	private static final String _SQL_SELECT_USERNOTIFICATIONDELIVERY_PKS_WHERE = "SELECT userNotificationDeliveryId FROM UserNotificationDelivery userNotificationDelivery WHERE ";
	...
	private static final String _SQL_DELETE_USERNOTIFICATIONDELIVERY = "DELETE UserNotificationDelivery userNotificationDelivery";
	private static final String _SQL_DELETE_USERNOTIFICATIONDELIVERY_WHERE = "DELETE UserNotificationDelivery userNotificationDelivery WHERE ";
