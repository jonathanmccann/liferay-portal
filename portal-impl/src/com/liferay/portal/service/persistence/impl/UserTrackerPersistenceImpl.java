...
public class UserTrackerPersistenceImpl extends BasePersistenceImpl<UserTracker>
	...
	protected void bulkRemoveByCompanyId(long companyId) {
		...
		query.append(_SQL_DELETE_USERTRACKER_WHERE);
	...
	public void removeBySessionId(String sessionId) {
		if (_isBulkRemovePossible()) {
			bulkRemoveBySessionId(sessionId);
	...
	protected void bulkRemoveBySessionId(String sessionId) {
		StringBundler query = new StringBundler(2);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_USERTRACKER);
	...
	private static final String _SQL_SELECT_USERTRACKER_PKS = "SELECT userTrackerId FROM UserTracker userTracker";
	...
	private static final String _SQL_SELECT_USERTRACKER_PKS_WHERE = "SELECT userTrackerId FROM UserTracker userTracker WHERE ";
	...
	private static final String _SQL_DELETE_USERTRACKER = "DELETE UserTracker userTracker";
	private static final String _SQL_DELETE_USERTRACKER_WHERE = "DELETE UserTracker userTracker WHERE ";
