...
public class RecentLayoutSetBranchPersistenceImpl extends BasePersistenceImpl<RecentLayoutSetBranch>
	...
	protected void bulkRemoveByGroupId(long groupId) {
		...
		query.append(_SQL_DELETE_RECENTLAYOUTSETBRANCH_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_RECENTLAYOUTSETBRANCH);
	...
	private static final String _SQL_SELECT_RECENTLAYOUTSETBRANCH_PKS = "SELECT recentLayoutSetBranchId FROM RecentLayoutSetBranch recentLayoutSetBranch";
	...
	private static final String _SQL_SELECT_RECENTLAYOUTSETBRANCH_PKS_WHERE = "SELECT recentLayoutSetBranchId FROM RecentLayoutSetBranch recentLayoutSetBranch WHERE ";
	...
	private static final String _SQL_DELETE_RECENTLAYOUTSETBRANCH = "DELETE RecentLayoutSetBranch recentLayoutSetBranch";
	private static final String _SQL_DELETE_RECENTLAYOUTSETBRANCH_WHERE = "DELETE RecentLayoutSetBranch recentLayoutSetBranch WHERE ";
