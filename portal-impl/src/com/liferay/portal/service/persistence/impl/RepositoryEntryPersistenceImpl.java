...
public class RepositoryEntryPersistenceImpl extends BasePersistenceImpl<RepositoryEntry>
	...
	protected void bulkRemoveByUuid(String uuid) {
		...
		query.append(_SQL_DELETE_REPOSITORYENTRY_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_REPOSITORYENTRY);
	...
	private static final String _SQL_SELECT_REPOSITORYENTRY_PKS = "SELECT repositoryEntryId FROM RepositoryEntry repositoryEntry";
	...
	private static final String _SQL_SELECT_REPOSITORYENTRY_PKS_WHERE = "SELECT repositoryEntryId FROM RepositoryEntry repositoryEntry WHERE ";
	...
	private static final String _SQL_DELETE_REPOSITORYENTRY = "DELETE RepositoryEntry repositoryEntry";
	private static final String _SQL_DELETE_REPOSITORYENTRY_WHERE = "DELETE RepositoryEntry repositoryEntry WHERE ";
