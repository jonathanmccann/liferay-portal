...
public class LayoutSetPrototypePersistenceImpl extends BasePersistenceImpl<LayoutSetPrototype>
	...
	protected void bulkRemoveByUuid(String uuid) {
		...
		query.append(_SQL_DELETE_LAYOUTSETPROTOTYPE_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_LAYOUTSETPROTOTYPE);
	...
	private static final String _SQL_SELECT_LAYOUTSETPROTOTYPE_PKS = "SELECT layoutSetPrototypeId FROM LayoutSetPrototype layoutSetPrototype";
	...
	private static final String _SQL_SELECT_LAYOUTSETPROTOTYPE_PKS_WHERE = "SELECT layoutSetPrototypeId FROM LayoutSetPrototype layoutSetPrototype WHERE ";
	...
	private static final String _SQL_DELETE_LAYOUTSETPROTOTYPE = "DELETE LayoutSetPrototype layoutSetPrototype";
	private static final String _SQL_DELETE_LAYOUTSETPROTOTYPE_WHERE = "DELETE LayoutSetPrototype layoutSetPrototype WHERE ";
