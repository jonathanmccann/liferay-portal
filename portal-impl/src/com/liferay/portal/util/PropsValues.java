...
public class PropsValues {
	...
	public static final String[] FIELD_EDITABLE_COM_LIFERAY_PORTAL_MODEL_USER_DEFAULT = PropsUtil.getArray(PropsKeys.FIELD_EDITABLE_COM_LIFERAY_PORTAL_MODEL_USER_DEFAULT);

	public static final String[] FIELD_EDITABLE_COM_LIFERAY_PORTAL_MODEL_USER_FIELDS = PropsUtil.getArray(PropsKeys.FIELD_EDITABLE_COM_LIFERAY_PORTAL_MODEL_USER_FIELDS);
