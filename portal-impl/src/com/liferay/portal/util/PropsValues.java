...
public class PropsValues {
	...
	public static final boolean DYNAMIC_DATA_MAPPING_PUBLISH_TO_LIVE_BY_DEFAULT = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.DYNAMIC_DATA_MAPPING_PUBLISH_TO_LIVE_BY_DEFAULT));
