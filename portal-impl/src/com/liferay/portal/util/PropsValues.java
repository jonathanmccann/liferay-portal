...
public class PropsValues {
	...
	public static final String[] FIELDS_EDITABLE_DEFAULT_COM_LIFERAY_PORTAL_MODEL_USER = PropsUtil.getArray(PropsKeys.FIELDS_EDITABLE_DEFAULT_COM_LIFERAY_PORTAL_MODEL_USER);
	
	public static final String[] FIELDS_EDITABLE_EXCEPTIONS_COM_LIFERAY_PORTAL_MODEL_USER = PropsUtil.getArray(PropsKeys.FIELDS_EDITABLE_EXCEPTIONS_COM_LIFERAY_PORTAL_MODEL_USER);

	public static final String[] FIELDS_EDITABLE_WHITELIST_COM_LIFERAY_PORTAL_MODEL_USER = PropsUtil.getArray(PropsKeys.FIELDS_EDITABLE_WHITELIST_COM_LIFERAY_PORTAL_MODEL_USER);
