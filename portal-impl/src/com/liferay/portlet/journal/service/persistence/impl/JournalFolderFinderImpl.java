...
public class JournalFolderFinderImpl extends BasePersistenceImpl<JournalFolder>
	...
	public int countF_A_ByG_F(
		...
		return doCountF_A_ByG_U_F(groupId, 0, folderId, queryDefinition, false);
	}
	...
	public int filterCountF_A_ByG_F(
		...
		return doCountF_A_ByG_U_F(groupId, 0, folderId, queryDefinition, true);
	}
	...
	public List<Object> filterFindF_A_ByG_F(
		...
		return doFindF_A_ByG_U_F(groupId, 0, folderId, queryDefinition, true);
	}
	...
	public List<Object> findF_A_ByG_F(
		...
		return doFindF_A_ByG_U_F(groupId, 0, folderId, queryDefinition, false);
	}
