...
public class SocialActivityLimitPersistenceImpl extends BasePersistenceImpl<SocialActivityLimit>
	...
	protected void bulkRemoveByGroupId(long groupId) {
		...
		query.append(_SQL_DELETE_SOCIALACTIVITYLIMIT_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_SOCIALACTIVITYLIMIT);
	...
	private static final String _SQL_SELECT_SOCIALACTIVITYLIMIT_PKS = "SELECT activityLimitId FROM SocialActivityLimit socialActivityLimit";
	...
	private static final String _SQL_SELECT_SOCIALACTIVITYLIMIT_PKS_WHERE = "SELECT activityLimitId FROM SocialActivityLimit socialActivityLimit WHERE ";
	...
	private static final String _SQL_DELETE_SOCIALACTIVITYLIMIT = "DELETE SocialActivityLimit socialActivityLimit";
	private static final String _SQL_DELETE_SOCIALACTIVITYLIMIT_WHERE = "DELETE SocialActivityLimit socialActivityLimit WHERE ";
