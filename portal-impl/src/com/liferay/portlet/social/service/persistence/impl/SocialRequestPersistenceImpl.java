...
public class SocialRequestPersistenceImpl extends BasePersistenceImpl<SocialRequest>
	...
	protected void bulkRemoveByUuid(String uuid) {
		...
		query.append(_SQL_DELETE_SOCIALREQUEST_WHERE);
	...
	public void removeByR_S(long receiverUserId, int status) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByR_S(receiverUserId, status);
	...
	protected void bulkRemoveByR_S(long receiverUserId, int status) {
		StringBundler query = new StringBundler(3);
	...
	public void removeByU_C_C_T_S(long userId, long classNameId, long classPK,
		int type, int status) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByU_C_C_T_S(userId, classNameId, classPK, type, status);
	...
	protected void bulkRemoveByU_C_C_T_S(long userId, long classNameId,
		long classPK, int type, int status) {
		StringBundler query = new StringBundler(6);
	...
	public void removeByC_C_T_R_S(long classNameId, long classPK, int type,
		long receiverUserId, int status) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByC_C_T_R_S(classNameId, classPK, type, receiverUserId,
				status);
	...
	protected void bulkRemoveByC_C_T_R_S(long classNameId, long classPK,
		int type, long receiverUserId, int status) {
		StringBundler query = new StringBundler(6);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_SOCIALREQUEST);
	...
	private static final String _SQL_SELECT_SOCIALREQUEST_PKS = "SELECT requestId FROM SocialRequest socialRequest";
	...
	private static final String _SQL_SELECT_SOCIALREQUEST_PKS_WHERE = "SELECT requestId FROM SocialRequest socialRequest WHERE ";
	...
	private static final String _SQL_DELETE_SOCIALREQUEST = "DELETE SocialRequest socialRequest";
	private static final String _SQL_DELETE_SOCIALREQUEST_WHERE = "DELETE SocialRequest socialRequest WHERE ";
