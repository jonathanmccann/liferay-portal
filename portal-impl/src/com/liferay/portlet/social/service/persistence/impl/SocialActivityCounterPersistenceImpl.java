...
public class SocialActivityCounterPersistenceImpl extends BasePersistenceImpl<SocialActivityCounter>
	...
	protected void bulkRemoveByGroupId(long groupId) {
		...
		query.append(_SQL_DELETE_SOCIALACTIVITYCOUNTER_WHERE);
	...
	public void removeByG_C_C_O(long groupId, long classNameId, long classPK,
		int ownerType) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByG_C_C_O(groupId, classNameId, classPK, ownerType);
	...
	protected void bulkRemoveByG_C_C_O(long groupId, long classNameId,
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_SOCIALACTIVITYCOUNTER);
	...
	private static final String _SQL_SELECT_SOCIALACTIVITYCOUNTER_PKS = "SELECT activityCounterId FROM SocialActivityCounter socialActivityCounter";
	...
	private static final String _SQL_SELECT_SOCIALACTIVITYCOUNTER_PKS_WHERE = "SELECT activityCounterId FROM SocialActivityCounter socialActivityCounter WHERE ";
	...
	private static final String _SQL_DELETE_SOCIALACTIVITYCOUNTER = "DELETE SocialActivityCounter socialActivityCounter";
	private static final String _SQL_DELETE_SOCIALACTIVITYCOUNTER_WHERE = "DELETE SocialActivityCounter socialActivityCounter WHERE ";
