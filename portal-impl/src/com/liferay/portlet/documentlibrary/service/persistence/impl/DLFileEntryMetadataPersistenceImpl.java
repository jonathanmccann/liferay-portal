...
public class DLFileEntryMetadataPersistenceImpl extends BasePersistenceImpl<DLFileEntryMetadata>
	...
	protected void bulkRemoveByUuid(String uuid) {
		...
		query.append(_SQL_DELETE_DLFILEENTRYMETADATA_WHERE);
	...
	public void removeByFileVersionId(long fileVersionId) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByFileVersionId(fileVersionId);
	...
	protected void bulkRemoveByFileVersionId(long fileVersionId) {
		StringBundler query = new StringBundler(2);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_DLFILEENTRYMETADATA);
	...
	private static final String _SQL_SELECT_DLFILEENTRYMETADATA_PKS = "SELECT fileEntryMetadataId FROM DLFileEntryMetadata dlFileEntryMetadata";
	...
	private static final String _SQL_SELECT_DLFILEENTRYMETADATA_PKS_WHERE = "SELECT fileEntryMetadataId FROM DLFileEntryMetadata dlFileEntryMetadata WHERE ";
	...
	private static final String _SQL_DELETE_DLFILEENTRYMETADATA = "DELETE DLFileEntryMetadata dlFileEntryMetadata";
	private static final String _SQL_DELETE_DLFILEENTRYMETADATA_WHERE = "DELETE DLFileEntryMetadata dlFileEntryMetadata WHERE ";
