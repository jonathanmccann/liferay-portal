...
public class ExpandoRowPersistenceImpl extends BasePersistenceImpl<ExpandoRow>
	...
	protected void bulkRemoveByTableId(long tableId) {
		...
		query.append(_SQL_DELETE_EXPANDOROW_WHERE);
	...
	protected void bulkRemoveByClassPK(long classPK) {
		StringBundler query = new StringBundler(2);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_EXPANDOROW);
	...
	private static final String _SQL_SELECT_EXPANDOROW_PKS = "SELECT rowId_ FROM ExpandoRow expandoRow";
	...
	private static final String _SQL_SELECT_EXPANDOROW_PKS_WHERE = "SELECT rowId_ FROM ExpandoRow expandoRow WHERE ";
	...
	private static final String _SQL_DELETE_EXPANDOROW = "DELETE ExpandoRow expandoRow";
	private static final String _SQL_DELETE_EXPANDOROW_WHERE = "DELETE ExpandoRow expandoRow WHERE ";
