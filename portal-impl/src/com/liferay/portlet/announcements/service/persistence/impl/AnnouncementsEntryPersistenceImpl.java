...
public class AnnouncementsEntryPersistenceImpl extends BasePersistenceImpl<AnnouncementsEntry>
	...
	protected void bulkRemoveByUuid(String uuid) {
		...
		query.append(_SQL_DELETE_ANNOUNCEMENTSENTRY_WHERE);
	...
	public void removeByC_C_A(long classNameId, long classPK, boolean alert) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByC_C_A(classNameId, classPK, alert);
	...
	protected void bulkRemoveByC_C_A(long classNameId, long classPK,
		boolean alert) {
		StringBundler query = new StringBundler(4);
	...
	public void removeByC_C_C_A(long companyId, long classNameId, long classPK,
		boolean alert) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByC_C_C_A(companyId, classNameId, classPK, alert);
	...
	protected void bulkRemoveByC_C_C_A(long companyId, long classNameId,
		long classPK, boolean alert) {
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_ANNOUNCEMENTSENTRY);
	...
	private static final String _SQL_SELECT_ANNOUNCEMENTSENTRY_PKS = "SELECT entryId FROM AnnouncementsEntry announcementsEntry";
	...
	private static final String _SQL_SELECT_ANNOUNCEMENTSENTRY_PKS_WHERE = "SELECT entryId FROM AnnouncementsEntry announcementsEntry WHERE ";
	...
	private static final String _SQL_DELETE_ANNOUNCEMENTSENTRY = "DELETE AnnouncementsEntry announcementsEntry";
	private static final String _SQL_DELETE_ANNOUNCEMENTSENTRY_WHERE = "DELETE AnnouncementsEntry announcementsEntry WHERE ";
