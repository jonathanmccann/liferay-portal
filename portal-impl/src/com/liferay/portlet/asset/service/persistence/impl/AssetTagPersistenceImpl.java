...
public class AssetTagPersistenceImpl extends BasePersistenceImpl<AssetTag>
	...
	protected void bulkRemoveByUuid(String uuid) {
		...
		query.append(_SQL_SELECT_ASSETTAG_PKS_WHERE);
		...
		query.setStringAt(_SQL_DELETE_ASSETTAG_WHERE, 0);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_SELECT_ASSETTAG_PKS);
			...
			q = session.createQuery(_SQL_DELETE_ASSETTAG);
	...
	private static final String _SQL_SELECT_ASSETTAG_PKS = "SELECT tagId FROM AssetTag assetTag";
	...
	private static final String _SQL_SELECT_ASSETTAG_PKS_WHERE = "SELECT tagId FROM AssetTag assetTag WHERE ";
	...
	private static final String _SQL_DELETE_ASSETTAG = "DELETE AssetTag assetTag";
	private static final String _SQL_DELETE_ASSETTAG_WHERE = "DELETE AssetTag assetTag WHERE ";
