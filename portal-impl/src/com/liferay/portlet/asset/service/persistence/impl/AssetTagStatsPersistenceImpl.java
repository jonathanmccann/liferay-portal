...
public class AssetTagStatsPersistenceImpl extends BasePersistenceImpl<AssetTagStats>
	...
	protected void bulkRemoveByTagId(long tagId) {
		StringBundler query = new StringBundler(2);

		query.append(_SQL_DELETE_ASSETTAGSTATS_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_ASSETTAGSTATS);
	...
	private static final String _SQL_SELECT_ASSETTAGSTATS_PKS = "SELECT tagStatsId FROM AssetTagStats assetTagStats";
	...
	private static final String _SQL_SELECT_ASSETTAGSTATS_PKS_WHERE = "SELECT tagStatsId FROM AssetTagStats assetTagStats WHERE ";
	...
	private static final String _SQL_DELETE_ASSETTAGSTATS = "DELETE AssetTagStats assetTagStats";
	private static final String _SQL_DELETE_ASSETTAGSTATS_WHERE = "DELETE AssetTagStats assetTagStats WHERE ";
