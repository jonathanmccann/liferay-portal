...
<liferay-ui:error exception="<%= GroupKeyException.class %>">
	...
	<p><liferay-ui:message arguments="<%= new String[] {subject, siteNameGeneralRestrictions, siteNameReservedWords} %>" key="the-x-cannot-be-x-or-a-reserved-word-such-as-x" /></p>

	<p><liferay-ui:message arguments="<%= new String[] {subject, siteNameInvalidCharacters} %>" key="the-x-cannot-contain-the-following-invalid-characters-x" /></p>
