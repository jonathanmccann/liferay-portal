...
>
	...
	>
		<clay:content-col
			expand="<%= true %>"
		>
			<span class="heading-text text-secondary" id="<portlet:namespace />objectsIncludedTitle"><liferay-ui:message key="object-definitions-included-in-the-xml-sitemap" /></span>
		</clay:content-col>
	...
	<p class="c-mb-0 c-mt-2 small text-secondary"><liferay-ui:message key="when-a-display-page-template-is-applied-to-an-object-definition,-its-object-entries-are-eligible-to-be-added-to-the-sitemap-xml" /></p>
		...
		>
			...
			>
				<liferay-ui:search-container-row
					...
					escapedModel="<%= true %>"
					keyProperty="externalReferenceCode"
					modelVar="objectDefinition"
					rowIdProperty="externalReferenceCode"
				>
					<liferay-ui:search-container-column-text
						name="object-definition-label"
						truncate="<%= true %>"
					>
					...
					<liferay-ui:search-container-column-text>
						<clay:button
							...
							borderless="<%= true %>"
							cssClass="lfr-portal-tooltip remove-button"
							data-rowId="<%= objectDefinition.getExternalReferenceCode() %>"
							displayType=""
							icon="times-circle"
							monospaced="<%= true %>"
							small="<%= true %>"
