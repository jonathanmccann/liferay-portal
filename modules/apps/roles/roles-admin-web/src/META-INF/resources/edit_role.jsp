...
<aui:form action="<%= editRoleURL %>" method="post" name="fm">
	...
	<liferay-ui:error exception="<%= RoleNameException.class %>">
		...
		<p><liferay-ui:message arguments="<%= new String[] {subject, roleNameGeneralRestrictions, roleNameReservedWords} %>" key="the-x-cannot-be-x-or-a-reserved-word-such-as-x" /></p>

		<p><liferay-ui:message arguments="<%= new String[] {subject, roleNameInvalidCharacters} %>" key="the-x-cannot-contain-the-following-invalid-characters-x" /></p>
