...
<div class="row">
	<aui:fieldset cssClass="col-md-6">
		...
		<liferay-ui:error exception="<%= OrganizationNameException.class %>">
			...
			String organizationNameGeneralRestrictions = "blank";

			String organizationNameReservedWords = StringPool.NULL;
			%>

			<liferay-ui:message arguments="<%= new String[] {subject, organizationNameGeneralRestrictions, organizationNameReservedWords} %>" key="the-x-cannot-be-x-or-a-reserved-word-such-as-x" />
		</liferay-ui:error>
