...
/**
 * Provides the local service interface for Engagement. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EngagementLocalServiceUtil
...
public interface EngagementLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EngagementLocalServiceUtil} to access the engagement local service. Add custom service methods to {@link com.liferay.gsportal.core.service.impl.EngagementLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Engagement createEngagement(long engagementId);
	...
	*/
	...
	public Engagement deleteEngagement(Engagement engagement);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Engagement deleteEngagement(long engagementId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Engagement fetchEngagement(long engagementId);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Engagement updateEngagement(Engagement engagement);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Engagement> getEngagements(int start, int end);
