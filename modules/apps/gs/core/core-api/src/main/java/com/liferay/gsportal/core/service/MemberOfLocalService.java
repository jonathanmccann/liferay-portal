...
/**
 * Provides the local service interface for MemberOf. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MemberOfLocalServiceUtil
...
public interface MemberOfLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MemberOfLocalServiceUtil} to access the member of local service. Add custom service methods to {@link com.liferay.gsportal.core.service.impl.MemberOfLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public MemberOf addMemberOf(MemberOf memberOf);
	...
	*/
	public MemberOf createMemberOf(long memberOfId);
	...
	*/
	...
	public MemberOf deleteMemberOf(MemberOf memberOf);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public MemberOf deleteMemberOf(long memberOfId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MemberOf fetchMemberOf(long memberOfId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MemberOf getMemberOf(long memberOfId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public MemberOf updateMemberOf(MemberOf memberOf);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MemberOf> getMemberOfs(int start, int end);
