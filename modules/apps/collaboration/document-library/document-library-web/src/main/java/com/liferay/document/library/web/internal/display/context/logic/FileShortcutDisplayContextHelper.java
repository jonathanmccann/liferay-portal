 ...
 * @author IL (Brian) Kim
 */
public class FileShortcutDisplayContextHelper extends FileEntryDisplayContextHelper {

	public FileShortcutDisplayContextHelper(
			PermissionChecker permissionChecker, FileEntry fileEntry, FileShortcut fileShortcut) {
	...
	public boolean hasPermissionsPermission() throws PortalException {
		if (_hasShortcutPermissionsPermission == null) {
			_hasShortcutPermissionsPermission = DLFileShortcutPermission.contains(
	...
	protected void _setValuesForNullFileShortcut() {
