...
public class GadgetPersistenceImpl extends BasePersistenceImpl<Gadget>
	...
	protected void bulkRemoveByUuid(String uuid) {
		...
		query.append(_SQL_DELETE_GADGET_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_GADGET);
	...
	private static final String _SQL_SELECT_GADGET_PKS = "SELECT gadgetId FROM Gadget gadget";
	...
	private static final String _SQL_SELECT_GADGET_PKS_WHERE = "SELECT gadgetId FROM Gadget gadget WHERE ";
	...
	private static final String _SQL_DELETE_GADGET = "DELETE Gadget gadget";
	private static final String _SQL_DELETE_GADGET_WHERE = "DELETE Gadget gadget WHERE ";
