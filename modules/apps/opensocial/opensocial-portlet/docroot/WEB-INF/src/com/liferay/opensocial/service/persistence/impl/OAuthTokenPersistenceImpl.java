...
public class OAuthTokenPersistenceImpl extends BasePersistenceImpl<OAuthToken>
	...
	public void removeByG_S(String gadgetKey, String serviceName) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByG_S(gadgetKey, serviceName);
	...
	protected void bulkRemoveByG_S(String gadgetKey, String serviceName) {
		StringBundler query = new StringBundler(3);

		query.append(_SQL_DELETE_OAUTHTOKEN_WHERE);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_OAUTHTOKEN);
	...
	private static final String _SQL_SELECT_OAUTHTOKEN_PKS = "SELECT oAuthTokenId FROM OAuthToken oAuthToken";
	...
	private static final String _SQL_SELECT_OAUTHTOKEN_PKS_WHERE = "SELECT oAuthTokenId FROM OAuthToken oAuthToken WHERE ";
	...
	private static final String _SQL_DELETE_OAUTHTOKEN = "DELETE OAuthToken oAuthToken";
	private static final String _SQL_DELETE_OAUTHTOKEN_WHERE = "DELETE OAuthToken oAuthToken WHERE ";
