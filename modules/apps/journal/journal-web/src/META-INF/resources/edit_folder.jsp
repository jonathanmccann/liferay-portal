...
<aui:form action="<%= editFolderURL %>" method="post" name="fm">
	...
	<liferay-ui:error exception="<%= FolderNameException.class %>">
		...
		String folderNameGeneralRestrictions = "blank";
		...
		<p><liferay-ui:message arguments="<%= new String[] {subject, folderNameGeneralRestrictions, folderNameReservedWords} %>" key="the-x-cannot-be-x-or-a-reserved-word-such-as-x" /></p>

		<p><liferay-ui:message arguments="<%= new String[] {subject, folderNameInvalidCharacters} %>" key="the-x-cannot-contain-the-following-invalid-characters-x" /></p>
