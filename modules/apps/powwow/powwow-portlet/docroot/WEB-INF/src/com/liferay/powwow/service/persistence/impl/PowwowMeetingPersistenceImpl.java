...
public class PowwowMeetingPersistenceImpl extends BasePersistenceImpl<PowwowMeeting>
	...
	protected void bulkRemoveByGroupId(long groupId) {
		...
		query.append(_SQL_DELETE_POWWOWMEETING_WHERE);
	...
	public void removeByPowwowServerId(long powwowServerId) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByPowwowServerId(powwowServerId);
	...
	protected void bulkRemoveByPowwowServerId(long powwowServerId) {
		StringBundler query = new StringBundler(2);
	...
	public void removeByPSI_S(long powwowServerId, int status) {
		if (_isBulkRemovePossible()) {
			bulkRemoveByPSI_S(powwowServerId, status);
	...
	protected void bulkRemoveByPSI_S(long powwowServerId, int status) {
		StringBundler query = new StringBundler(3);
	...
	protected void bulkRemoveAll() {
		...
		try {
			...
			q = session.createQuery(_SQL_DELETE_POWWOWMEETING);
	...
	private static final String _SQL_SELECT_POWWOWMEETING_PKS = "SELECT powwowMeetingId FROM PowwowMeeting powwowMeeting";
	...
	private static final String _SQL_SELECT_POWWOWMEETING_PKS_WHERE = "SELECT powwowMeetingId FROM PowwowMeeting powwowMeeting WHERE ";
	...
	private static final String _SQL_DELETE_POWWOWMEETING = "DELETE PowwowMeeting powwowMeeting";
	private static final String _SQL_DELETE_POWWOWMEETING_WHERE = "DELETE PowwowMeeting powwowMeeting WHERE ";
