...
public interface SiteResource {
	...
	public Site postSiteFile(Site site, Map<String, File> multipartFiles)
		throws Exception;

	public HttpInvoker.HttpResponse postSiteFileHttpResponse(
	...
	public static class SiteResourceImpl implements SiteResource {
		...
		public Site postSiteFile(Site site, Map<String, File> multipartFiles)
			...
			HttpInvoker.HttpResponse httpResponse = postSiteFileHttpResponse(
				site, multipartFiles);
		...
		public HttpInvoker.HttpResponse postSiteFileHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-site/v1.0/sites/files");
