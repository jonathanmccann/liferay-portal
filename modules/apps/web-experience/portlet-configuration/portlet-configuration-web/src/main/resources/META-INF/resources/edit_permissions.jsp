		...
		<div class="portlet-configuration-body-content">
			...
			<div class="container-fluid-1280">
				...
				<liferay-ui:search-container
					...
					total="<%= RoleLocalServiceUtil.getGroupRolesAndTeamRolesCount(company.getCompanyId(), excludedRoleNamesArray, roleTypes, modelResourceRoleId, teamGroupId) %>"
				>
					<liferay-ui:search-container-results
						results="<%= RoleLocalServiceUtil.getGroupRolesAndTeamRoles(company.getCompanyId(), excludedRoleNamesArray, roleTypes, modelResourceRoleId, teamGroupId, searchContainer.getStart(), searchContainer.getResultEnd()) %>"
					/>
